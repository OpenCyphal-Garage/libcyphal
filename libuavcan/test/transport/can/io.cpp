...
{
    // Memory
    uavcan::PoolAllocator<sizeof(uavcan::CanTxQueueEntry) * 4, sizeof(uavcan::CanTxQueueEntry)> pool;
...
TEST(CanIOManager, Loopback)
{
    ...
    // Memory
    uavcan::PoolAllocator<sizeof(CanTxQueueEntry) * 4, sizeof(CanTxQueueEntry)> pool;
