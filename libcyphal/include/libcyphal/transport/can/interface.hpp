...
/// @file
/// Cyphal Transport Interface used to communicate over a CAN bus
...
public:
    ...
    public:
        ...
        virtual void onReceive(const media::can::extended::Frame& frame) = 0;
...
#endif  // LIBCYPHAL_TRANSPORT_INTERFACE_HPP_INCLUDED
