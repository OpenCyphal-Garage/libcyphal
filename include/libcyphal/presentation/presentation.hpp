...
///
template <typename T, bool = IsServiceTrait<T>::value && decltype(HasFixedPortIdTrait<typename T::Request>(0))::value>
...
public:
    ...
    auto makeServer(const transport::PortId                                           service_id,
        ...
        -> Expected<Server<Request, Response>, transport::AnyFailure>
    {
    ...
    ///                         Can be assigned (or reset) later via `Server::setOnRequestCallback`.
    ///
    template <typename Service, typename Result = Expected<ServiceServer<Service>, transport::AnyFailure>>
    auto makeServer(const transport::PortId                                        service_id,
    ...
    auto makeServer(const transport::PortId                         service_id,
        ...
        -> Expected<RawServiceServer, transport::AnyFailure>
    {
