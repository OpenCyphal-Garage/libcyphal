...
/// @file
/// @todo This file is currently not being used. We should determine if we should use this file for
///   memory allocation etc. and create a task to use this class throughout libcyphal
