...
/// @file
/// @todo: Merge with libcyphal/include/libcyphal/media/can/* as needed
/// @note This file is not currently being used but is in the process of being merged

#ifndef LIBCYPHAL_TRANSPORT_MEDIA_CAN_HPP_UNUSED
#define LIBCYPHAL_TRANSPORT_MEDIA_CAN_HPP_UNUSED
...
public:
    ...
    Frame(std::uint32_t can_id, const std::uint8_t* can_data, FrameDLC in_dlc)
        : Frame(can_id, can_data, in_dlc, time::Monotonic::fromMicrosecond(0))
    {
    }
...
#endif  // LIBCYPHAL_TRANSPORT_MEDIA_CAN_HPP_UNUSED
