...
static constexpr std::size_t NodeMemPoolSize = 1024 * 5; //Fits ram FIXME
		                                       //1024 * 512;  ///< This shall be enough for any possible use case
...
public:
    ...
    /**
     * Allocates @ref uavcan_nuttx::BlockingServiceClient in the heap using shared pointer.
     * The service client will be initialized immediately.
     * @throws uavcan_nuttx::Exception.
     */
    template <typename DataType>
                                   ...
                                   SystemClock::detectPreferredClockAdjustmentMode())
{
    ...
    if (res < 0)
    {       
       std::cout << "LIBUAVCAN: makeNode error " << res << std::endl;
    }
 ...
 * Clock adjustment mode will be detected automatically unless provided explicitly.
 *
 * @throws uavcan_nuttx::Exception, uavcan_nuttx::LibuavcanErrorException.
 */
template <typename DriverType>
