...
public:
    ...
    ///
    virtual cetl::optional<SetError> set(const IRegister::Name name, const IRegister::Value& new_value) = 0;
...
public:
    ...
    /// @return Name of the register. Empty if the index is out of range.
    ///
