...
TEST_F(TestPublisher, copy_move_getSetPriority)
{
    ...
    static_assert(std::is_copy_assignable<Publisher<Message>>::value, "");
    static_assert(std::is_move_assignable<Publisher<Message>>::value, "");
    static_assert(std::is_copy_constructible<Publisher<Message>>::value, "");
    static_assert(std::is_move_constructible<Publisher<Message>>::value, "");
...
TEST_F(TestPublisher, publishRawData)
{
    ...
    static_assert(std::is_copy_assignable<Publisher<void>>::value, "");
    static_assert(std::is_move_assignable<Publisher<void>>::value, "");
    static_assert(std::is_copy_constructible<Publisher<void>>::value, "");
    static_assert(std::is_move_constructible<Publisher<void>>::value, "");
    static_assert(!std::is_default_constructible<Publisher<void>>::value, "");
