...
public:
    ...
    Base(const char* can_interface, const NodeID node_id) noexcept
        ...
        , primary_bus_{transport::can::CANInterface(input_session_, output_session_)}
        , can_{new transport::can::CyphalCANTransport(primary_bus_,
                                                      nullptr,
                                                      node_id,
                                                      timer_,
                                                      heap_,
    ...
    {
        return can_->initialize();
    }

protected:
    transport::can::CANInterface        primary_bus_;
